...
registerMooseObject("MGDiffusionApp", BlockAverageDiffusionMaterial);
...
BlockAverageDiffusionMaterial::computeQpProperties()
{
  ...
  // element
  _thermal_conductivity[_qp] = 0.5 * _block_average_value.averageValue(_current_elem->subdomain_id());
}